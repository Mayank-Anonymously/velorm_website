...
import productSmall from '@/assets/prods/image-two.png';
import productMain from '@/assets/prods/image-one.png';
import categoriesImg from '@/assets/prods/image-three.png';
import recommendedImg from '@/assets/prods/image-two.png';
						...
						<div className='lg:col-span-7 h-full flex flex-col justify-center relative'>
							<motion.div
								...
								<div className='flex flex-col lg:flex-row items-center gap-8 mt-12'>
									<p className='text-black-400 max-w-sm text-center lg:text-left leading-relaxed'>
										Velorm elevates your daily routine — blending care,
						...
						<div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
							...
							<motion.div
								...
								<h2 className='text-5xl font-serif text-white mb-6 leading-tight'>
									Revitalizing Kesar Chandan
								</h2>
								<p className='text-gray-400 text-lg mb-8 leading-relaxed'>
									Formulated with nature. The ultimate companion for your
									ritual.
								</p>
